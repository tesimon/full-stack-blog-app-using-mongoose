import { CatagorylList as CatagorylLists } from "@/constants/catagory";
...
const CatagorylList = async ({ title, style }) => {
  return (
    <div className="flex flex-col items-center gap-4 justify-center mt-20  ">
      ...
      <div className="flex flex-col sm:flex-row justify-start gap-3 sm:gap-5  flex-wrap items-center my-10  ">
        {CatagorylLists.map((item) => (
          <Link
